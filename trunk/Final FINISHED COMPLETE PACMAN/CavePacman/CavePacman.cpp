...
void CavePacman::init()
{
	...
	texture = CaveLib::loadTexture("data/CavePacman/Images/grid.jpg", t);
	t = new TextureLoadOptions();
	t->sampler = TextureLoadOptions::CLOSEST;
	groundTexture = CaveLib::loadTexture("data/CavePacman/Images/dirt.jpg", t);
	t = new TextureLoadOptions();
	t->sampler = TextureLoadOptions::CLOSEST;
	woodTexture = CaveLib::loadTexture("data/CavePacman/Images/wood.jpg", t);
	sounds[0].Load("data/CavePacman/Sounds/pacman_beginning.wav");
	sounds[1].Load("data/CavePacman/Sounds/pacman_chomp.wav");
	sounds[2].Load("data/CavePacman/Sounds/pacman_death.wav");
	sounds[3].Load("data/CavePacman/Sounds/pacman_eatghost.wav");
	sounds[4].Load("data/CavePacman/Sounds/jump.wav");
	sounds[5].Load("data/CavePacman/Sounds/pacman_eatfruit.wav");
	sounds[6].Load("data/CavePacman/Sounds/pacman_intermission.wav");
	...
	dead=false; poweredup=false; victory = false;
	Powerupstart = clock();
...
{
	glBindTexture(GL_TEXTURE_2D, woodTexture->tid());
	glNormal3d(0, 0, 1);
	glBegin(GL_QUADS);
	//back
